...
CoD.PartyLobby.PopulateButtons = function (f17_arg0)
	f17_arg0.body.findMatchButton = f17_arg0.body.buttonList:addButton(Engine.Localize("FIND MATCH"), nil, 1)
...
CoD.PartyLobby.PopulateButtons_Multiplayer = function (PartyLobbyButtonPane)
	PartyLobbyButtonPane.body.serverBrowserButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("SERVER BROWSER"), nil, 1)
	PartyLobbyButtonPane.body.serverBrowserButton.hintText = Engine.Localize(CoD.MPZM("Change your loadout, and see your stats for public servers.", "ZMUI_PLAYER_MATCH_DESC"))
	PartyLobbyButtonPane.body.serverBrowserButton:setActionEventName("open_server_browser_partylobby")
	CoD.SetupMatchmakingLock(PartyLobbyButtonPane.body.serverBrowserButton)
	PartyLobbyButtonPane.body.createAClassButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("CREATE A CLASS"), nil, 2)
	...
	PartyLobbyButtonPane.body.rewardsButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("SCORESTREAKS"), nil, 3)
	...
	PartyLobbyButtonPane.body.buttonList:addSpacer(CoD.CoD9Button.Height / 2, 4)
	PartyLobbyButtonPane.body.barracksButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("BARRACKS"), nil, 5)
...
CoD.PartyLobby.new = function (f29_arg0, f29_arg1, f29_arg2)
	...
	PartyLobbyWidget:registerEventHandler("open_server_browser_partylobby", CoD.MainLobby.OpenIMGUIServerBrowser)
